...
public class EventServiceImpl implements EventService {
	...
	@Override
	public void rejectUser(Integer theUserId, Integer eventId) {
		eventDao.rejectUser(theUserId, eventId);
	}

	@Override
	public List<Event> listRecentEvents() {
		return eventDao.listRecentEvents();
	}

	@Override
	public List<Participant> getParticipants(Integer eventId) {
